...
const MyQuestions = ({ route, navigation }) => {
  ...
  const createTwoButtonAlert = (id) => {
    Alert.alert(
      "Warning",
      "Once you pressed ok, the question will be permanently deleted.",
      [
        {
          text: "Cancel",
          onPress: () => {
      ...
      <SafeAreaView>
        <ScrollView>
          ...
          <Pressable
              ...
              onPress={() => {
                navigation.navigate("IsImageIncluded", {
                  subjectName: subjectName,
                });
              }}
              android_ripple={{ color: "grey" }}
            >
              <Text style={styles.bigButtonText}>+ ADD NEW QUESTION</Text>
            </Pressable>
              ...
              questions.map((quest, idx) => (
                <View key={idx}>
                  <View style={styles.table}>
                    <Text style={[styles.item, { textAlign: "justify", fontWeight: "bold" }]}>
